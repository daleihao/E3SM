...
contains
  ...
  subroutine lnd2atm_minimal(bounds, &
      surfalb_vars, surfrad_vars, solarabs_vars, energyflux_vars, atm2lnd_vars, lnd2atm_vars)
    !
    ! !DESCRIPTION:
    ...
    type(surfrad_type)    , intent(in)    :: surfrad_vars
    ...
    associate( &
      ...
      fsr_vis_d_patch    => surfrad_vars%fsr_vis_d_patch      , &
      fsr_vis_i_patch    => surfrad_vars%fsr_vis_i_patch      , &
