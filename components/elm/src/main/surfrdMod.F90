...
#include "shr_assert.h"
  ...
  public :: surfrd_ktop_data     ! Read topography dataset for kTOP parameterization
  !
...
!-----------------------------------------------------------------------
  subroutine surfrd_ktop_data(domain,filename)
! !DESCRIPTION:
! Read the topography parameters for kTOP parameterization:
! Assume domain has already been initialized and read
...
!EOP
    ...
    character(len=256)  :: locfn            ! local file name
    logical             :: readvar          ! is variable on file
    character(len=32)   :: subname = 'surfrd_ktop_data'     ! subroutine name
!-----------------------------------------------------------------------
  ...
  end subroutine surfrd_ktop_data
